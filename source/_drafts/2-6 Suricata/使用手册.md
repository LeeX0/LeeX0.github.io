...
对于信创入侵防御系统，使用安装包ips_1.1.3_aarch64.zip使用如下命令进行安装：

```bash
unzip ips_1.1.3_aarch64.zip
chmod +x *.sh
...
![image-20210903165903313](使用手册/image-20210903165903313.png)
...
![image-20210903170130293](使用手册/image-20210903170130293.png)

#### 2.3 规则集导入

可在右上角点击导入“规则按钮”进行规则集导入。

![image-20210903173336140](使用手册/image-20210903173336140.png)
